...
{\fixme{РАЗРАБОТКА АТОМНО-ЗОНДОВОГО ТОМОГРАФА С ФЕМТОСЕКУНДНЫМ ЛАЗЕРНЫМ ИСПАРЕНИЕМ ДЛЯ ИЗУЧЕНИЯ ТРЕХМЕРНОГО РАСПРЕДЕЛЕНИЯ ЭЛЕМЕНТОВ С АТОМАРНЫМ МАСШТАБОМ В СПЛАВАХ}}
