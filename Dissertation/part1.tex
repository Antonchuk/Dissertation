...
%		\includegraphics[width=0.49\linewidth]{mullerenergy} \\ а)
%	\end{minipage}
%	\hfill
%	\begin{minipage}[b][][b]{0.49\linewidth}\centering
%		\includegraphics[width=0.9\linewidth]{mullerenergy} \\ б)
%	\end{minipage}
